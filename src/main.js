...
var listaRegistros = { //variavel pela admnistração de registros
    ultimoIdGerado:0,
    usuarios:[]
}
...
function lerBD(){
    ...
    function desenhar(){
        ...
        if(tbody){
            ...
            data = data
                .sort( (a, b) => { //lista de usuario ordem alfabetica
...
function insertUsuario(nome, fone){
    ...
    gravarBD ()//grava diretamente no banco de dados
    desenhar() //aparecer na tabela
    vizualizar('lista')
...
function vizualizar(pagina, novo=false, id=null){
    ...
    if(pagina === 'cadastro'){
        ...
        document.getElementById('nome').focus()//ao ir para pagina de cadastro ele ja entra focado no nome para digitar.
    }
}
